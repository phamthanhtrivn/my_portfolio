...
export function TechStack() {
  return (
    <section
      id="techstack"
      className="border-b border-line py-24 transition-colors duration-300"
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <Reveal className="max-w-3xl">
          ...
          <p className="mt-3 text-muted">
            The stack is grouped by role so the system reads like a working
            production toolchain, not a keyword dump.
          </p>
        </Reveal>
